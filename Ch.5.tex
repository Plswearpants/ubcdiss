...
We will quantitatively show case this \ac{LDOS} modulation with a simulation on a toy model in the following section. 
...
\end{align}
Note that in the actual numerical calculation, the integral will be evaluated on a n by n grid of k-points.  
