...
Quasiparticles is any long-lived, well-defined excitation in a system that behaves like a particle, it is a semi-classical term used to describe particle interactions in terms of renormalized single-particle excitation. In Fermionic systems, it correspond to a sharp peak in the spectra function: 
	\[
...
Quasiparticle is an object in the semi-classical picture that aims to capture the excitation of a system with interactive particles. As a term used extensively by the condensed matter physics community, nuanced discussions on the underlying assumptions and limitations of the semi-classical picture is often lacking. 

This sections aims to help establish a firm understanding of the semi-classical picture through the lens of Fermi liquid theory, more specifically, it aims to answer the following practical questions:
\begin{itemize}
