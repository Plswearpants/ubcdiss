...
%% \begin{dinglist}{##}\item... or dingautolist (which auto-increments)
	...
	\examiningcommittee{Alison Lister, Professor, Physics, \textsc{UBC}}%
	{Supervisory Committee Member}
	\examiningcommittee{Marcel Franz, Professor, Physics, \textsc{UBC}}%
	{Supervisory Committee Member}
	...
	%% files
	\hypersetup{
		pdftitle={UBC dissertation  (DRAFT: \today)},
		pdfauthor={Dong Chen},
