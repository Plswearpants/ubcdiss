...
"The way to derive Bardeen's tunneling theory is not straightforward; it does not proceed by routine application of textbook techniques"~\cite{gottliebBardeensTunnelingTheory2006a}. Here I follow the approach of Gottlieb and Wesoloski~\cite{gottliebBardeensTunnelingTheory2006a}, which was mostly inspired by C.~B.~Duke \cite{dukeTunnelingSolids1973}. The readers are encouraged to read the full derivation in this comprehensive and accessible tutorial by Gottlieb and Wesoloski~\cite{gottliebBardeensTunnelingTheory2006a}. 
