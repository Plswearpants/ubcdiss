...
\begin{figure}
	...
	\caption[Selective band scattering in ZrSiS]{\textbf{Selective band scattering in ZrSiS}. On the left, the \ac{FT} of the entire grid map (shown in the inset) reveals band scattering with various features. 
		...
		Reproduced with permission from Butler \textit{et al.}, \textit{Phys. Rev. B} \textbf{96}, 195125 (2017). 
		\textcopyright{} 2017 American Physical Society. 
		\href{https://doi.org/10.1103/PhysRevB.96.195125}{https://doi.org/10.1103/PhysRevB.96.195125}}
	\label{fig:ch6_ZrSiS}
\end{figure}
